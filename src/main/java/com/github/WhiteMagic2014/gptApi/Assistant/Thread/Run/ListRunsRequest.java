 ...
 **/
public class ListRunsRequest extends GptRequest {

    public ListRunsRequest server(String server) {
        this.server = server;
        return this;
    }
    ...
    public ListRunsRequest gptHttpUtil(GptHttpUtil gptHttpUtil) {
        this.gptHttpUtil = gptHttpUtil;
        return this;
    }

    public ListRunsRequest key(String key) {
        this.key = key;
        return this;
    }

    public ListRunsRequest organization(String organization) {
    ...
    public ListRunsRequest threadId(String threadId) {
    ...
    public ListRunsRequest limit(int limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListRunsRequest order(String order) {
        this.order = order;
        return this;
    }
    ...
    public ListRunsRequest after(String after) {
        this.after = after;
        return this;
    }
     ...
     * @return
     */
    public ListRunsRequest before(String before) {
        this.before = before;
        return this;
    }
    ...
    public List<ThreadRun> sendForThreadRuns() {
        JSONArray data = send().getJSONArray("data");
        return JSONArray.parseArray(data.toString(), ThreadRun.class);
    }
